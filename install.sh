...
unzip -o "$ZIPFILE" 'BharatOS/*' -d $MODPATH >&2
  
if [ -f "/system/media/bootanimation.zip" ]; then
mkdir -p $MODPATH/system/media
cp -f $MODPATH/BharatOS/bootanimation.zip $MODPATH/system/media/
...
cp -f $MODPATH/BharatOS/bootanimation.zip $MODPATH/system/product/media/
ui_print " [*] Installing bootanimation to system/product/media"

else
ui_print " This Looks like non supported Rom... Report in support group @magibootchat"
exit 1;
fi
ui_print ""
ui_print " [*] Done!"
